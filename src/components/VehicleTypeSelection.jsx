    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-text">Car Insurance</h3>
          <p className="text-text/80">Comprehensive coverage for your car</p>
        </div>
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-text">Motorcycle Insurance</h3>
          <p className="text-text/80">Specialized coverage for your motorcycle</p>
        </div>
      </div>
    </div>
  );
